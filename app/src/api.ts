...
export const browserAdapter: SeamstressAPI = {
  ...
  importReconstruction: async () => desktopRequired(),
  getAISettings: async () => desktopRequired(),
  setAIKey: async () => desktopRequired(),
  clearAIKey: async () => desktopRequired(),
  getSegmentationStatus: async () => desktopRequired(),
